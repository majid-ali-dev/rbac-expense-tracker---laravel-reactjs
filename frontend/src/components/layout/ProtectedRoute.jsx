...
const ProtectedRoute = () => {
    ...
    if (loading || !authChecked) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-[#f1f2f6] dark:bg-[#131a3a]">
    ...
    return (
        <div className="flex min-h-screen bg-[#f1f2f6] dark:bg-[#131a3a] transition-colors">
            <Sidebar />
