...
import { FaArrowLeft, FaUser, FaTag, FaMoneyBillWave, FaCalendar, FaFileText, FaUserCog } from 'react-icons/fa';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                    <div className="p-2 bg-red-100 rounded-xl">
                        <FaFileText className="text-red-600" size={18} />
                    </div>
                ...
                <div className="md:col-span-2 flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                    <div className="p-2 bg-indigo-100 rounded-xl">
                        <FaUserCog className="text-indigo-600" size={18} />
                    </div>
                    <div>
